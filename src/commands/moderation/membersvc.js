...
module.exports = {
    ...
    async execute(interaction, err) {
        ...
        if (!interaction.member.permissions.has(PermissionsBitField.Flags.ManageChannels) && interaction.user.id !== '619944734776885276') return await interaction.reply({
        ...
        switch (sub) {
            case 'total-set':
                ...
                if (!voicedata) {
                    ...
                    const voiceembed = new EmbedBuilder()
                        .setColor('DarkBlue')
                        //.setThumbnail('https://cdn.discordapp.com/avatars/841679967993331723/a_d8c4c9b7c52eb2306ead4e48266ea3d8.gif?size=4096')
                        .setAuthor({
                            name: `🔊 Member Voice Tool`
                        })
                        .setTimestamp()
                        .setTitle('> Total Members channel has \n> been set up')
                        .addFields({
                            name: `• Channel was Set Up`,
                            value: `> Your channel (${voicechannel}) has been set \n> up to be your total members \n> voice channel! It will now display your \n> total members accordingly.`
                        })
                        .setFooter({
                            text: `🔊 Total Channel Set`
                        })
                    ...
                    await interaction.reply({
                        content: `You have **already** set up a **total members** VC in this server!`,
                        ephemeral: true
                    })
                }
            ...
            case 'total-remove':
                ...
                const totalremovedata = await voiceschema.findOne({
                    Guild: interaction.guild.id
                });

                if (!totalremovedata) return await interaction.reply({
                    content: `You **have not** set up a **total members** VC yet, cannot delete **nothing**..`,
                    ephemeral: true
                });
                else {
                    ...
                    if (!removechannel) {
                        ...
                        await voiceschema.deleteMany({
                            Guild: interaction.guild.id
                        });
                        await interaction.reply({
                            content: `Your **total member** VC seems to be corrupt or non existant, we **disabled** it regardless!`,
                            ephemeral: true
                        });
                        ...
                        await removechannel.delete().catch(err => {
                            voiceschema.deleteMany({
                                Guild: interaction.guild.id
                            });
                            return interaction.reply({
                                content: `**Couldn't** delete your VC, but we **still** disabled your **total members** VC!`,
                                ephemeral: true
                            })
                        });
                        ...
                        await interaction.reply({
                            content: `Your **total members** VC has been **successfuly** disabled!`,
                            ephemeral: true
                        });
                    }
                }
            ...
            case 'bot-set':
                ...
                if (!botdata) {
                    ...
                    const botembed = new EmbedBuilder()
                        ...
                        .addFields({
                            name: `• Channel was Set Up`,
                            value: `> Your channel (${botguildchannel}) has been set \n> up to be your total members \n> voice channel! It will now display your \n> total members accordingly.`
                        })
                        .setFooter({
                            text: `🔊 Total Channel Set`
                        })
                    ...
                    await interaction.reply({
                        content: `You have **already** set up a **total bots** VC in this server!`,
                        ephemeral: true
                    })
                }
            ...
            case 'bot-remove':
                ...
                const totalbotdata = await botschema.findOne({
                    Guild: interaction.guild.id
                });

                if (!totalbotdata) return await interaction.reply({
                    content: `You **have not** set up a **total bots** VC yet, cannot delete **nothing**..`,
                    ephemeral: true
                });
                else {
                    ...
                    if (!removebotchannel) {
                        ...
                        await interaction.reply({
                            content: `Your **total bots** VC seems to be corrupt or non existant, we **disabled** it regardless!`,
                            ephemeral: true
                        });
                        ...
                        await removebotchannel.delete().catch(err => {
                            botschema.deleteMany({
                                Guild: interaction.guild.id
                            });
                            return interaction.reply({
                                content: `**Couldn't** delete your VC, but we **still** disabled your **total bots** VC!`,
                                ephemeral: true
                            })
                        });
                        ...
                        await interaction.reply({
                            content: `Your **total bots** VC has been **successfuly** disabled!`,
                            ephemeral: true
                        });
                    }
                }
