    ...
    async execute(interaction, client) {
        ...
        switch (options.getSubcommand()) {
            ...
            case "view":
                ...
                channelDBS = await ChannelDB.findOne({
                    guild: guildId
                });
                ...
                const rank = new Rank()
                    ...
                    //.setBackground("IMAGE", channelDBS ?.image || "https://cdn.discordapp.com/icons/1014510991352021082/fc2c53cf42995cae01da40d5cf8e556d.webp");

                rank.build().then((data) => {
                    interaction.reply({
                        files: [new AttachmentBuilder(data, {
                            name: "rank.png"
                        })],
                    });
                });
            ...
            case "status":
                ...
                const channelDB3 = await ChannelDB.findOne({
                    guild: guild.id
                });
